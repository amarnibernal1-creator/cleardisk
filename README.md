...
- If it is a `.dmg` file, a window will open showing the cleardisk app icon. Drag this icon into your Applications folder.  
- If it is a `.zip` file, unzip it and move the app to your Applications folder.
...
### 6. Use the App from the Menu Bar
...
## 📋 How to Use cleardisk Efficiently
...
## ✅ What Caches Can cleardisk Clear?
